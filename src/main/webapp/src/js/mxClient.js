var mxClient = {
    ...
    IS_MT: 0 <= navigator.userAgent.indexOf("Firefox/") && 0 > navigator.userAgent.indexOf("Firefox/1.") && 0 > navigator.userAgent.indexOf("Firefox/2.") || 0 <= navigator.userAgent.indexOf("Iceweasel/") && 0 > navigator.userAgent.indexOf("Iceweasel/1.") &&
    0 > navigator.userAgent.indexOf("Iceweasel/2.") || 0 <= navigator.userAgent.indexOf("SeaMonkey/") && 0 > navigator.userAgent.indexOf("SeaMonkey/1.") || 0 <= navigator.userAgent.indexOf("Iceape/") && 0 > navigator.userAgent.indexOf("Iceape/1."),
    IS_SVG: 0 <= navigator.userAgent.indexOf("Firefox/") || 0 <= navigator.userAgent.indexOf("Iceweasel/") || 0 <= navigator.userAgent.indexOf("Seamonkey/") || 0 <= navigator.userAgent.indexOf("Iceape/") || 0 <= navigator.userAgent.indexOf("Galeon/") || 0 <= navigator.userAgent.indexOf("Epiphany/") || 0 <=
...
var mxEffects = {
    ...
    intersection: function (a, b, c, d, e, f, g, h) {
        ...
        return g >= 0 && g <= 1 && e >= 0 &&
        e <= 1 ? new mxPoint(a + g * (c - a), b + g * (d - b)) : null
    },
    ...
    removeStylename: function (a, b) {
        var c = [];
        if (a != null)for (var d =
            a.split(";"), e = 0; e < d.length; e++)d[e] != b && c.push(d[e]);
        return c.join(";")
    },
    ...
    setStyle: function (a, b, c) {
        var d = c != null && (typeof c.length == "undefined" ||
            c.length > 0);
    ...
    setStyleFlag: function (a, b, c, d) {
        if (a ==
            null || a.length == 0)a = d || d == null ? b + "=" + c : b + "=0"; else {
            var e = a.indexOf(b + "=");
            if (e < 0) {
    ...
    getSizeForString: function (a, b, c) {
        ...
        d.style.fontFamily =
            c || mxConstants.DEFAULT_FONTFAMILY;
        d.style.position = "absolute";
    ...
    getViewXml: function (a, b, c, d, e) {
        ...
        if (a.dialect == mxConstants.DIALECT_SVG) {
            f.drawPane =
                document.createElementNS(mxConstants.NS_SVG, "g");
    ...
    show: function (a, b, c, d) {
        ...
        if (mxClient.IS_IE) {
            ...
            if (a != null) {
                ...
                c = a.ownerSVGElement;
                c.setAttribute("width", e.width + Math.max(e.x,
                        0) + 3);
...
var mxClipboard = {
    STEPSIZE: 10, insertCount: 1, cells: null, isEmpty: function () {
...
mxImageExport.prototype.createShape = function () {
    return {
        drawShape: function (a, b, c, d) {
            var e = {
                translate: new mxPoint(c.x, c.y), moveTo: function (b, c) {
...
mxImageExport.prototype.initShapes = function () {
    ...
    this.shapes.arrow = {
        drawShape: function (a, c, d, e) {
            if (e) {
                var d = mxConstants.ARROW_SPACING, f = mxConstants.ARROW_WIDTH, e = mxConstants.ARROW_SIZE, c = c.absolutePoints, g = c[0], c = c[c.length - 1], h = c.x - g.x, k = c.y - g.y, i = Math.sqrt(h * h + k * k), l = i - 2 * d - e, e = h / i, k = k / i, i = f * k / 3, f = -f * e / 3, h = g.x - i / 2 + d * e, g = g.y - f / 2 + d * k, m = h + i, n = g + f, o = m + l * e, l = n + l * k, p = o + i, q = l + f, t = p - 3 * i, u = q - 3 *
                    f;
                a.begin();
                a.moveTo(h, g);
                a.lineTo(m, n);
    ...
    this.shapes.actor = {
        drawShape: function (a, c, d, e) {
            if (e) {
                ...
                a.curveTo(c + f / 2 + g, e, c + f / 2 + g, e + 2 * d /
                    5, c + f / 2, e + 2 * d / 5);
    ...
    this.shapes.cloud = {
        drawShape: function (a, c, d, e) {
            if (e) {
                ...
                a.curveTo(c + f, e + 0.3 * d, c + 0.8 * f, e + 0.1 * d, c + 0.625 * f, e + 0.2 *
                    d);
...
var mxXmlCanvas2D = function (a) {
        var b = new mxUrlConverter, c = true, d = true, e = a.ownerDocument, f = [], g = {
            alpha: 1,
            dashed: false,
            strokewidth: 1,
    ...
    mxSvgCanvas2D = function (a, b) {
        ...
        var i = {
            ...
            fontFamily: mxConstants.DEFAULT_FONTFAMILY,
            fontStyle: 0
        }, l = true, m = null, n = null, o = null, p = null, q = [], t = 0, u = [], v = function (a, b) {
            var c = "margin:0px;font-size:" + Math.floor(i.fontSize) + "px;font-family:" + i.fontFamily +
                ";color:" + i.fontColor + ";";
            ...
            if (c != null) {
                ...
                f && (e.fill != null || e.gradient != null) ? e.gradient != null ? c.setAttribute("fill", "url(#" + e.gradient + ")") : c.setAttribute("fill", e.fill.toLowerCase()) : b || c.setAttribute("fill",
                    "none");
                if (g && e.stroke != null) {
        ...
        return {
            ...
            setFoEnabled: function (a) {
                ...
                e = e * i.scale;
                if (b ^ c) {
                    var f = b ? d : 0, b = b ? -1 : 1, g = c ? e : 0, c = c ? -1 : 1;
                ...
                if (a != null && b != null) {
                    ...
                    e = e.toLowerCase();
                    f = null;
                    if (k == null || k == mxConstants.DIRECTION_SOUTH)f = "s"; else if (k == mxConstants.DIRECTION_EAST)f = "e"; else {
                        var l = d, d = e, e = l;
                ...
                if (m == null) {
                    ...
                    a.setAttribute("style",
                        "stop-color:#ffffff;stop-opacity:0.1");
                    m.appendChild(a);
                ...
                var h = c.convert(h),
                    k = k != null ? k : true, l = l != null ? l : false, m = m != null ? m : false, b = b + i.dx, d = d + i.dy, n = g("image");
                ...
                if (e) {
                    ...
                    if (f && q == "html") {
                        ...
                        var q =
                            Math.floor(i.fontSize), p = g("g"), t = i.transform;
                        if (o) {
                            o = d + k / 2;
                        ...
                        (i.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC &&
                        ...
                        n == null || n == mxConstants.ALIGN_TOP ?
                            d = Math.max(d - 3 * i.scale, d + m / 2 + (k > 0 ? l / 2 - 8 : 0)) : n == mxConstants.ALIGN_MIDDLE ? d = d + m / 2 : n == mxConstants.ALIGN_BOTTOM && (d = Math.min(d, d + m + 2 * i.scale));
                        d = d + q;
                ...
                if (o != null) {
                    ...
                    e = e + i.dx;
                    f = f + i.dy;
                    o.push("C " + r(a * i.scale) + " " + r(b * i.scale) + " " + r(c * i.scale) + " " + r(d * i.scale) + " " + r(e * i.scale) + " " + r(f *
                            i.scale));
                    l = false
                }
            }, close: function () {
...
mxStencil.prototype.renderDom = function (a, b, c, d) {
    ...
    if (this.bgNode != null || this.fgNode != null) {
        ...
        var v = Math.min(m, n), w = [], r = d != null ? d : {
...
var mxMarker = {
    markers: [], paintMarker: function (a, b, c, d, e, f, g, h, k, i, l, m) {
...
mxCellRenderer.prototype.createCellOverlays = function (a) {
    ...
    a.overlays != null && a.overlays.visit(function (a,
                                                     b) {
        b.destroy()
    });
    a.overlays = c
...
var mxEdgeStyle = {
    ...
    routePatterns: [[[513, 2308, 2081, 2562], [513, 1090, 514,
    ...
    inlineRoutePatterns: [[null, [2114, 2568], null, null], [null, [514, 2081, 2114,
        2568], null, null], [null, [2114, 2561], null, null], [[2081, 2562], [1057, 2114, 2568], [2184, 2562], null]],
    vertexSeperations: [],
    ...
    OrthConnector: function (a, b, c, d, e) {
        ...
        if (d != null && d.length > 0 || g || f)mxEdgeStyle.SegmentConnector(a,
            ...
            mxEdgeStyle.vertexSeperations[3] = Math.max(n -
                2 * f, 0);
            c = [];
            h = [];
            k = [];
            ...
            for (i = k = 0; i < q.length; i++) {
                ...
                if ((o || t) && m < 9) {
                    ...
                    if (k == 0) {
                        ...
                        m > 0 && (mxEdgeStyle.wayPoints1[f][0] = mxEdgeStyle.wayPoints1[f][0] +
                            l[0] * m)
                    } else {
    ...
    if (mxGraphHandler.prototype.maxCells <= 0 || this.graph.getSelectionCount() < mxGraphHandler.prototype.maxCells) {
        ...
        if (a || this.graph.isLabelMovable(this.state.cell) && this.state.width >= 2 && this.state.height >= 2) {
            ...
            if (a) {
                ...
                this.sizers.push(this.createSizer("se-resize",
                    b++))
            }
            ...
            this.labelShape =
                this.createSizer(mxConstants.CURSOR_MOVABLE_VERTEX, null, null, mxConstants.LABEL_HANDLE_FILLCOLOR);
            this.sizers.push(this.labelShape)
        }
    }
    this.redraw()
...
mxCellHighlight.prototype.repaint = function () {
    if (this.state != null && this.shape != null) {
        ...
        var a = !this.graph.model.isEdge(this.state.cell) ? Number(this.state.style[mxConstants.STYLE_ROTATION] || "0") :
            0;
        if (this.shape.dialect == mxConstants.DIALECT_SVG) {
            this.shape.node.setAttribute("style", "pointer-events:none;");
            if (a != 0) {
                var b = this.state.getCenterX(), c = this.state.getCenterY();
